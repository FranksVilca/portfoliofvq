    ...
    return (
        <div>
            <div className="bg-bag w-full px-20 md:px-20 px-6 py-20 md:py-20 py-12" id={id}>
                <h2 className="text-[#111827] text-3xl md:text-3xl text-2xl font-semibold">SERVICES</h2>
                    ...
                    <div className="flex flex-col gap-8 md:gap-8 gap-6 pt-8">
                        <div className="flex gap-8 md:gap-8 gap-4">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <p className="text-text md:text-base text-sm">Development of efficient and structured solutions.</p>
                            </div>
                        </div>
                        <div className="flex gap-8 md:gap-8 gap-4">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <p className="text-text md:text-base text-sm">Data cleaning and analysis to support informed decision-making.</p>
                            </div>
                        </div>
                        <div className="flex gap-8 md:gap-8 gap-4">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <p className="text-text md:text-base text-sm">Modern, responsive, and functional user interfaces.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-8 md:gap-8 gap-6 pt-8 md:pt-8 pt-0">
                        <div className="flex gap-8 md:gap-8 gap-4">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <p className="text-text md:text-base text-sm">Data exploration and modeling to uncover actionable insights.</p>
                            </div>
                        </div>
                        <div className="flex gap-8 md:gap-8 gap-4">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <p className="text-text md:text-base text-sm">Clear and interactive information visualization.</p>
                            </div>
                        </div>
                    </div>
                </div>
